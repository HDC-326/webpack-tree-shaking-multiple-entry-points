...
class Module extends DependenciesBlock {
	...
	isUsedInThisEntry(exportName, entryId) {
		const used = this.isUsed(exportName);
		if (
			!entryId ||
			!this.usedExportsOwners ||
			!Array.isArray(this.usedExportsOwners[exportName]) ||
			this.usedExportsOwners[exportName].includes(entryId)
		) {
			return used;
		}
		return false;
