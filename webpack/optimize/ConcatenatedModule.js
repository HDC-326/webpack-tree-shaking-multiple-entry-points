...
class ConcatenatedModule extends Module {
	constructor(rootModule, modules, concatenationList) {
		...
		this.usedExportsOwners = rootModule.usedExportsOwners;
	...
	source(dependencyTemplates, runtimeTemplate, type, entryId) {
